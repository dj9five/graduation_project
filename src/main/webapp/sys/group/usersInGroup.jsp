...
<form name="ActionForm" method="post" action="group.do" onSubmit="return check();">
    ...
    <div class="control">
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                onMouseOut="this.className='button';" onClick="if(check()) document.ActionForm.submit();"><img
                src="${pageContext.request.contextPath}/ui/images/button/baocun.png" border='0' align='absmiddle'>&nbsp;保存
        </button>
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                onMouseOut="this.className='button';" onClick="self.close();"><img
            ...
            <td>
                <div id="menu1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td>
                                <select name="lselect" size="1" multiple id="lslt" style="width:100%;height:250px"
                            ...
                            <td align="center">
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
                                        onMouseOut="this.className='button';" onClick="moveRight()"><img
                                        src="${pageContext.request.contextPath}/ui/images/button/youyi.png" border='0'
                                        align='absmiddle'>&nbsp;右移
                                </button>
                                <br/><br/>
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
                                        onMouseOut="this.className='button';" onClick="moveLeft()"><img
                                        src="${pageContext.request.contextPath}/ui/images/button/zuoyi.png" border='0'
                                        align='absmiddle'>&nbsp;左移
                                </button>
                                <br/><br/>
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
                                        onMouseOut="this.className='button';" onClick="moveAllRight()"><img
                                        src="${pageContext.request.contextPath}/ui/images/button/quanbuyy.png"
                                        border='0' align='absmiddle'>&nbsp;全部右移
                                </button>
                                <br/><br/>
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
                                        onMouseOut="this.className='button';" onClick="moveAllLeft()"><img
                                        src="${pageContext.request.contextPath}/ui/images/button/quanbuzy.png"
                                        border='0' align='absmiddle'>&nbsp;全部左移
                                </button>
                            </td>
                            <td>
                                <select name="rselect" size="1" multiple id="rslt" style="width:100%;height:250px"
                                        onDblClick="moveLeft()">
