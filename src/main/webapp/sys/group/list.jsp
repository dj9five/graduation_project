    ...
    <form name="form2" method="post" action="${pageContext.request.contextPath}/sys/sysUserGroupList.do">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="PowerTable" class="PowerTable">
            ...
            <tr>
                ...
                <td>xxxx</td>
                <td>xxx</td>
                <td><a href="javascript:OpenWin('${pageContext.request.contextPath}/sys/group/usersInGroup.jsp?id=12')">设置</a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>王天</td>
                <td></td>
                <td><a href="javascript:OpenWin('${pageContext.request.contextPath}/sys/group/usersInGroup.jsp?id=13')">设置</a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>王天</td>
                <td></td>
                <td><a href="javascript:OpenWin('${pageContext.request.contextPath}/sys/group/usersInGroup.jsp?id=14')">设置</a>
                </td>
            </tr>
