...
<form name="ActionForm" method="post" enctype="multipart/form-data"
      action="${pageContext.request.contextPath}/crm/customer/file/edit.jsp" onSubmit="return check();">
            ...
            <td>
                <div id="menu2">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="16%">创建人：</td>
                            <td width="34%"><input name="creator" type="text" class="disabled" id="creator"
                                                   value="系统管理员" style="width:90%" readonly></td>
                            <td width="16%">创建时间：</td>
                            <td width="34%"><input name="createTimeStr" class="disabled" readonly
                                                   value="2010-03-29 22:52:39" type="text" id="createTimeStr"
                                                   style="width:90%"></td>
                        </tr>
                        <tr>
                            <td>修改人：</td>
                            ...
                            <td>
                                ...
                                <input name="updateTimeStr2" class="disabled" readonly value="2010-03-29 22:52:39"
