                ...
                <form name="form2" method="post" action="linkman.do">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="12%" nowrap><input name="code" type="text" id="code" value=""
                                                          style="width:110px"></td>
                            <td width="15%" nowrap>姓名：</td>
                            <td width="12%" nowrap><input name="name" type="text" id="name" value=""
                                                          style="width:110px"></td>
                        ...
                        <tr>
                            ...
                            <td>联系地址：</td>
                            <td colspan="3"><input name="address" type="text" id="address" value="" style="width:100%">
                            </td>
                        </tr>
                        <tr>
                            <td>邮政编码：</td>
                            ...
                            <td>备注：</td>
                            <td colspan="3"><input name="remark" type="text" id="remark" value="" style="width:100%">
                            </td>
                        </tr>
                        <tr>
                            <td>出生日期：</td>
                            <td><input name="birthday" type="text" id="birthday" class="dateClassStyle" value=""
                                       style="width:110px"></td>
                        </tr>
                    </table>
                </form>
