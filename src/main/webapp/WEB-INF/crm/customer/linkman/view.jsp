            ...
            <form name="form1" method="post" action="linkmanlist.do">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" name="base" id="base">
                    <tr>
                        ...
                        <td width="15%" nowrap><input name="name" type="text" id="name" value="" style="width:110px">
                        </td>
                        <td width="12%" nowrap>手机：</td>
                        <td width="15%" nowrap><input name="mobile" type="text" id="mobile" value=""
                                                      style="width:110px"></td>
                        <td width="12%" nowrap>QQ号：</td>
                        <td width="15%" nowrap><input name="imNum" type="text" id="imNum" value="" style="width:110px">
                        </td>
