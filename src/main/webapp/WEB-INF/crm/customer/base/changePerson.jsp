...
<body>
<div id="loadDiv"
     style="display:none; background-color:#62B6F2;border:'1' 'slid' '#000000';height:40;width:200;left:200px; top:19px; z-index:2 ;position:absolute;"
     align="center"><span style="font-size:9pt;color:#FFFFFF;"><br>
操作中，请稍等...</span></div>
        ...
        <tr>
            <td align="right">
                ...
                <button type='button' class='button' onMouseOver="this.className='button_over';"
                        onMouseOut="this.className='button';"
                        onClick="self.close();">
                    <img src="${pageContext.request.contextPath}/ui/images/button/quxiao.png" border='0'
                         align='absmiddle'>&nbsp;取消
                </button>
                &nbsp;&nbsp;
            </td>
