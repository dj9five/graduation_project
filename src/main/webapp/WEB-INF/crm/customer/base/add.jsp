...
<s:form name="companyForm" method="post" action="companyAction_save.do" namespace="/crm">
    ...
    <div class="control">
        ...
        <button type='button' class='button' onMouseOver="this.className='button_over';"
            ...
            <img src="${pageContext.request.contextPath}/ui/images/button/fanhui.png" border='0' align='absmiddle'>&nbsp;返回
        </button>
                ...
                <div id="menu1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="34%"><s:textfield id="code" name="code" value="%{#request.code}"
                                                         cssStyle="width:90%"/></td>
                            <td width="16%" class="red">客户名称：</td>
                            <td width="34%">
                                <s:textfield id="name" name="name" value="" cssStyle="width:90%"
                                             onblur="name2pinyin()"/>
                            </td>
                        </tr>
                        <tr>
                            <td>拼音码：</td>
                            <td>
                                <s:textfield id="pycode" name="pycode" value="" cssStyle="width:90%" readonly="true"
                                             cssClass="disabled"/>
                            </td>
                            <td>客户等级：</td>
                            <td>
                ...
                <div id="menu2">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td>法人代表：</td>
                            <td>
                                <s:textfield name="artificialPerson" id="artificialPerson" cssStyle="width:90%"
                                             value=""/></td>
                            <td>注册资金：</td>
