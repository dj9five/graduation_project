            ...
            <div id="menu1">
                <form name="form2" method="post" action="linktouch.do">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td width="19%" align="center" nowrap>
                                <div class="control">
                                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                                            onMouseOut="this.className='button';" onClick="document.form2.submit();">
                        ...
                        <tr>
                            <td>业务员：</td>
                            <td><input type='text' id='userName' name='userName' value='' style='width:90px'
                        ...
                        <tr>
                            ...
                            <td>联系时间：</td>
                            <td><select name='queryTime' id='queryTime' style='width:110px'
                                        onChange='changeQueryTime()'>
                                <option value='' selected>------</option>
                            ...
                            <td colspan="3">
                                <div id="CustomTime" style="float:left;display:none;"> 从
                                    ...
                                    到
                                    <input type='text' id='endTime2' name='endTime' value='2010-03-29'
                                           style='width:90px'><img
                                            src='${pageContext.request.contextPath}/ui/images/Calendar.gif'
