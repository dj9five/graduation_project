...
<div class="mtitle">
    ...
    <b><span id="menu_selected" class="menu_selected" style="font-size: larger">潜在客户信息管理</span></b>
</div>
<br>
            ...
            <s:form name="form1" method="post" action="companyAction_list.do" namespace="/crm">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" name="base" id="base">
                    <tr>
                        ...
                        <td width="12%" nowrap><input name="code" type="text" id="code" value="" style="width:110px">
                        </td>
                        <td width="15%" nowrap>客户名称：</td>
                        <td width="12%" nowrap><input name="name" type="text" id="name" value="" style="width:110px">
                        </td>
                        <td width="15%" nowrap>拼音码：</td>
                        <td width="12%" nowrap><input name="pycode" type="text" id="pycode" value=""
...
<div class="control">
    ...
    <button type='button' class='button' onMouseOver="this.className='button_over';"
        ...
        <img src="${pageContext.request.contextPath}/ui/images/button/shanchu.png" border='0' align='absmiddle'>&nbsp;升阶
    </button>
</div>
<div class="border">
    <s:form method="post" action="companyAction_advance_b.do" namespace="/crm">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="PowerTable" class="PowerTable">
            ...
            <s:if test="#request.companyList!=null">
                <s:iterator value="#request.companyList" var="company">
                    <tr>
                        <td>
                            <s:checkbox name="ids" fieldValue="%{#company.id}" cssClass="checkbox"
                                        onclick="changeCheckCount();"/>
                        </td>
                        <td>
                            <a href="${pageContext.request.contextPath}/crm/companyAction_edit.do?id=<s:property value="#company.id"/>"><s:property
