...
<form name="ActionForm" method="post" action="linktouch.do" onSubmit="">
    ...
    <div class="control">
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                ...
                onClick="forward('linktouchlist.do?method=listAll&m_type=customer')"><img
                src="${pageContext.request.contextPath}/ui/images/button/fanhui.png" border='0' align='absmiddle'>&nbsp;返回
        </button>
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                onMouseOut="this.className='button';" onClick="forward('linktouchlist.do?method=loadRead&id=0')"
                disabled><img src="${pageContext.request.contextPath}/ui/images/button/daoshouye.png" border='0'
                              align='absmiddle'>&nbsp;上一个
        </button>
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                onMouseOut="this.className='button';" onClick="forward('linktouchlist.do?method=loadRead&id=3')"><img
