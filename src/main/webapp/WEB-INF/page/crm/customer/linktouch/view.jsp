            ...
            <form name="form2" method="post" action="linktouchlist.do">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" name="adv" id="adv">
                    <tr>
                        ...
                        <td width="12%" nowrap><input name="linkMan" type="text" id="linkMan" value=""
                        ...
                        <td width="19%" align="center">
                            <div class="control">
                                ...
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
                                        onMouseOut="this.className='button';" onClick="goRefresh()"><img
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="100%"><input name="c_company" type="text" id="c_company" value=""
                                                            style="width:100%"></td>
                                    <td width="21"><img src="${pageContext.request.contextPath}/ui/images/lookup.gif"
                                                        width="21" height="19" style="cursor:hand"
                                                        onClick="searchCustomer2()"></td>
                                </tr>
                            </table>
                        </td>
                        <td>联系时间：
                        ...
                        <td colspan="3">
                            <div id="CustomTime" style="float:left;display:none;"> 从
                                <input type='text' id='beginTime2' name='beginTime' value='2010-02-28'
                                       style='width:130px'><img
                                        src='${pageContext.request.contextPath}/ui/images/Calendar.gif'
                                        name='beginTimeStrIMG2' style='cursor:hand' id='beginTimeStrIMG2'
                                ...
                                到
                                <input type='text' id='endTime2' name='endTime' value='2010-03-30'
                                       style='width:130px'><img
                                        src='${pageContext.request.contextPath}/ui/images/Calendar.gif'
                                        name='endTimeStrIMG2' style='cursor:hand' id='endTimeStrIMG2' align='absmiddle'
                                        alt='选择日期'/>
                                <script language='JavaScript'>Calendar.setup({
                                    inputField: "endTime2",
                                    ifFormat: "%Y-%m-%d",
...
<div class="border">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="PowerTable" class="PowerTable">
        <!-- title -->
        <tr>
            <td width="4%" class="listViewThS1"><input type="checkbox" name="checkall" value="" class="checkbox"
                                                       onClick="CheckAll(this.checked);changeCheckCount();"></td>
        ...
        <tr>
            ...
            <td>2010-03-29</td>
            <td><a href="javascript:forward('${pageContext.request.contextPath}/crm/customer/base/main.jsp')">北京软通动力软件技术有限公司</a>
            </td>
            <td>王刚</td>
            <td>登门拜访</td>
            <td>系统管理员</td>
        ...
        <tr>
            ...
            <td>2010-03-29</td>
            <td>
                <a href="javascript:forward('/crm/customer/std/main.jsp?back=list&isFrom=cvisit&id=8')">北京软通动力软件技术有限公司</a>
            </td>
            <td>张丹枫</td>
            <td>通过代理商联系</td>
            <td>系统管理员</td>
