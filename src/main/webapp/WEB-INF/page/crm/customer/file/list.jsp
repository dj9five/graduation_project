            ...
            <div id="menu1">
                <form name="form1" method="post" action="file.do">
                    ...
                    <table width="100%" border="0" cellspacing="5" cellpadding="0">
                            ...
                            <td width="23%" align="center">
                                <div class="control">
                                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                                            onMouseOut="this.className='button';" onClick="document.form1.submit();">
                        ...
                        <tr>
                            <td colspan="3">创建时间：
                                <input type='text' id='begintime' name='begintime' class="dateClassStyle" value=''
                                       style='width:120px'>
                                &nbsp;至&nbsp;
                                <input type='text' id='endtime' name='endtime' class="dateClassStyle" value=''
                                       style='width:120px'>
                            </td>
                        </tr>
                    </table>
...
<div class="control">
    ...
    <button type='button' class='button' onMouseOver="this.className='button_over';"
            onMouseOut="this.className='button';"
            onClick="delForm('${pageContext.request.contextPath}/crm/customer/file/view.jsp')"><img
            src="${pageContext.request.contextPath}/ui/images/button/shanchu.png" border='0' align='absmiddle'>&nbsp;删除
    </button>
</div>
<!-- list -->
<div class="border">
