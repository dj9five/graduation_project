            ...
            <form name="form1" method="post" action="customer.do">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" name="base" id="base">
                    <tr>
                        ...
                        <td width="12%" nowrap><input name="name" type="text" id="name" value="" style="width:100px">
                        </td>
                        ...
                        <td width="25%" align="center">
                            <div class="control">
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
                                        onMouseOut="this.className='button';" onClick="document.form1.submit();"><img
                                        src="${pageContext.request.contextPath}/ui/images/button/sousuo.png" border='0'
                                        align='absmiddle'>&nbsp;搜索
                                </button>
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
                                        onMouseOut="this.className='button';"
                                        onClick="forward('customer.do?method=select&columns=name&m=doCustomer2')"><img
                ...
                <table width="100%" style="display:none" border="0" cellspacing="0" cellpadding="0" name="adv" id="adv">
                    <tr>
                        ...
                        <td width="25%" align="center">
                            <div class="control">
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
                                        onMouseOut="this.className='button';" onClick="document.form2.submit();"><img
                                        src="${pageContext.request.contextPath}/ui/images/button/sousuo.png" border='0'
                                        align='absmiddle'>&nbsp;搜索
                                </button>
                                <button type='button' class='button' onMouseOver="this.className='button_over';"
...
<div class="control">
    <button type='button' class='button' onMouseOver="this.className='button_over';"
            onMouseOut="this.className='button';" onClick="window.close();"><img
            src="${pageContext.request.contextPath}/ui/images/button/guanbi.png" border='0' align='absmiddle'>&nbsp;关闭
    </button>
</div>
<!-- list -->
<div class="border">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listViewPaginationTdS1">
        <tr>
            ...
            <td width="71%" align="right">
                ...
                下一页&nbsp;
                末页&nbsp;
                <select id='_pj_pages1' name='_pj_pages1' onChange='toPage1()' style='font-size=11px;'>
                    <option value='1' selected>第1页</option>
                </select>
                <script>function toPage1() {
                ...
                <select id='_pj_pagesize1' name='_pj_pagesize1' onChange='changeSize1()' style='font-size=11px;'>
                ...
                <script>function changeSize1() {
                    var _pj_pagesize = document.getElementById('_pj_pagesize1').value;
    ...
    <form name="ActionForm" method="post" action="">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="PowerTable" class="PowerTable">
            ...
            <tr>
                <td>
                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                            onMouseOut="this.className='button';" onClick="parent('eeeee')"><img
                            src="${pageContext.request.contextPath}/ui/images/button/xuanze.png" border='0'
                            align='absmiddle'>&nbsp;选择
                    </button>
                </td>
            ...
            <tr>
                <td>
                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                            onMouseOut="this.className='button';" onClick="parent('北京软通动力软件技术有限公司')"><img
                            src="${pageContext.request.contextPath}/ui/images/button/xuanze.png" border='0'
                            align='absmiddle'>&nbsp;选择
                    </button>
                </td>
            ...
            <tr>
                <td>
                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                            onMouseOut="this.className='button';" onClick="parent('ttttttt')"><img
                            src="${pageContext.request.contextPath}/ui/images/button/xuanze.png" border='0'
                            align='absmiddle'>&nbsp;选择
                    </button>
                </td>
            ...
            <tr>
                <td>
                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                            onMouseOut="this.className='button';" onClick="parent('iiiii')"><img
                            src="${pageContext.request.contextPath}/ui/images/button/xuanze.png" border='0'
                            align='absmiddle'>&nbsp;选择
                    </button>
                </td>
            ...
            <tr>
                <td>
                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                            onMouseOut="this.className='button';" onClick="parent('dfdfgfdgd')"><img
                            src="${pageContext.request.contextPath}/ui/images/button/xuanze.png" border='0'
                            align='absmiddle'>&nbsp;选择
                    </button>
                </td>
            ...
            <tr>
                <td>
                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                            onMouseOut="this.className='button';" onClick="parent('zxvcdzxvdcv')"><img
                            src="${pageContext.request.contextPath}/ui/images/button/xuanze.png" border='0'
                            align='absmiddle'>&nbsp;选择
                    </button>
                </td>
            ...
            <tr>
                <td>
                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                            onMouseOut="this.className='button';" onClick="parent('传智播客')"><img
                            src="${pageContext.request.contextPath}/ui/images/button/xuanze.png" border='0'
                            align='absmiddle'>&nbsp;选择
                    </button>
                </td>
            ...
            <tr>
                <td>
                    <button type='button' class='button' onMouseOver="this.className='button_over';"
                            onMouseOut="this.className='button';" onClick="parent('dddd')"><img
                            src="${pageContext.request.contextPath}/ui/images/button/xuanze.png" border='0'
                            align='absmiddle'>&nbsp;选择
                    </button>
                </td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listViewPaginationTdS1">
        <tr>
            ...
            <td width="71%" align="right">
                ...
                下一页&nbsp;
                末页&nbsp;
                <select id='_pj_pages2' name='_pj_pages2' onChange='toPage2()' style='font-size=11px;'>
                    <option value='1' selected>第1页</option>
                </select>
                <script>function toPage2() {
                ...
                <select id='_pj_pagesize2' name='_pj_pagesize2' onChange='changeSize2()' style='font-size=11px;'>
                    <option value='10' selected>10条</option>
                    <option value='15'>15条</option>
                    <option value='20'>20条</option>
                    <option value='30'>30条</option>
