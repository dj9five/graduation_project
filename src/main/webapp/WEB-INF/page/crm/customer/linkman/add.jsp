            ...
            <td>
                <div id="menu1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td class="red">姓名：</td>
                            <td><input name="name" type="text" id="name" style="width:90%"
                        ...
                        <tr>
                            ...
                            <td>拼音码：</td>
                            <td><input name="pycode" type="text" id="pycode" style="width:90%" readonly
                                       class="disabled"></td>
                        </tr>
                        <tr>
                            <td>出生日期：</td>
                ...
                <div id="menu2">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="16%">创建日期：</td>
                            <td width="34%"><input name="create_time" class="disabled" value="2010-03-29 17:13:08"
                                                   type="text" id="create_time" style="width:90%" readonly></td>
                        </tr>
                        <tr>
                            <td>修改人：</td>
                            ...
                            <td>修改日期：</td>
                            <td><input name="updateTime" class="disabled" value="2010-03-29 17:13:08" type="text"
                                       id="update_time" style="width:90%" readonly></td>
                        </tr>
                        <tr>
                            <td>所属人：</td>
                            <td>
                                <input name="ownerUser" type="hidden" value="1">
                                <input name="ownerName" type="text" id="owner_name" class="disabled" style="width:90%"
