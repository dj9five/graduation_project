...
<s:form name="ActionForm" method="post" action="companyAction_updateShareSetOne.do" namespace="/crm">
    ...
    <div class="control">
        ...
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                ...
                onClick="selectAllBox()"><img src="${pageContext.request.contextPath}/ui/images/button/mokuaiqx.png"
                                              border='0'
                                              align='absmiddle'>&nbsp;模块全选
        </button>
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                onMouseOut="this.className='button';"
                onClick="unSelectAllBox()"><img src="${pageContext.request.contextPath}/ui/images/button/mokuaiqbx.png"
                                                border='0'
                                                align='absmiddle'>&nbsp;模块全不选
        </button>
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                onMouseOut="this.className='button';"
                onClick="document.forms[0].submit();"><img
                src="${pageContext.request.contextPath}/ui/images/button/baocun.png" border='0'
                align='absmiddle'>&nbsp;保存
        </button>
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                onMouseOut="this.className='button';"
                onClick="self.close();"><img src="${pageContext.request.contextPath}/ui/images/button/guanbi.png"
                                             border='0'
                                             align='absmiddle'>&nbsp;关闭
        </button>
        <font color="red"></font>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#6A82A8">
        <tr>
            <td align="center" height="25"><span class="Tabfont"><s:property value="%{#request.company.name}"/>(客户)待共享的模块</span>
            </td>
        </tr>
    </table>
    <div id="border" class="border" style="padding:3px">
        <fieldset style='padding:5px;clear:left;'>
            ...
            <div><input type='checkbox' class='checkbox' name='s_module' value='c_company' id='c_company'
                        onclick='do_select(this.id)'>客户资料
            </div>
            &nbsp;
        </fieldset>
    ...
    <div class="control">
        <button type='button' class='button' onMouseOver="this.className='button_over';"
            ...
            <img src="${pageContext.request.contextPath}/ui/images/button/yonghuqx.png" border='0' align='absmiddle'>&nbsp;用户全选
        </button>
        <button type='button' class='button' onMouseOver="this.className='button_over';"
                onMouseOut="this.className='button';"
                onClick="unSelectAllUser()">
            <img src="${pageContext.request.contextPath}/ui/images/button/yonghuqbx.png" border='0' align='absmiddle'>&nbsp;用户全不选
        </button>
    </div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center" height="25"><span class="Tabfont"><s:property value="%{#request.company.name}"/>(客户)待共享的用户</span>
            </td>
        </tr>
    </table>
