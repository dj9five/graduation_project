...
public class JFreeChartUtils {
    public static void generalBarJpeg(java.util.List<ReportBean> reportBeans, HttpServletRequest request, ServletContext sc) throws IOException, IOException {
        ...
        //保存生成的图形到某个路径下
        //获取图片的保存的路径
        String reaPath=sc.getRealPath("/menu");
